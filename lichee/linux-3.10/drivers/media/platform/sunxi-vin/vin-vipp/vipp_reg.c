...
void vipp_osd_rgb2yuv(unsigned int id, struct vipp_rgb2yuv_factor *factor)
{
	...
	vipp_reg_load_addr[id].vipp_osd_rgb2yuv_gain0->bits.jc2 = factor->jc2;
	vipp_reg_load_addr[id].vipp_osd_rgb2yuv_gain1->bits.jc3 = factor->jc3;
	vipp_reg_load_addr[id].vipp_osd_rgb2yuv_gain1->bits.jc4 = factor->jc4;
	vipp_reg_load_addr[id].vipp_osd_rgb2yuv_gain1->bits.jc5 = factor->jc5;
	vipp_reg_load_addr[id].vipp_osd_rgb2yuv_gain2->bits.jc6 = factor->jc6;
	vipp_reg_load_addr[id].vipp_osd_rgb2yuv_gain2->bits.jc7 = factor->jc7;
	vipp_reg_load_addr[id].vipp_osd_rgb2yuv_gain2->bits.jc8 = factor->jc8;
