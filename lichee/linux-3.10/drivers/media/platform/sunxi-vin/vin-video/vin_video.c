				    ...
				    bool set)
{
	...
	while (1) {
		...
		/*
		 * when diffrent video output have same sensor,
		 * this pipeline try fmt will lead to dead loop,
		 * so we use media_entity_graph_walk instead.
		 */
#if 0
