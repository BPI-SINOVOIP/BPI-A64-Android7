...
int isp_table_request(struct v4l2_subdev *sd)
{
	...
	if (isp->use_isp && isp->is_raw) {
		isp->isp_lut_tbl.size = ISP_LINEAR_LUT_LENS_GAMMA_MEM_SIZE;
		...
		tbl->isp_def_lut_tbl_paddr = (void *)(pa + ISP_LUT_MEM_OFS);
		tbl->isp_def_lut_tbl_dma_addr = (void *)(dma + ISP_LUT_MEM_OFS);
		tbl->isp_def_lut_tbl_vaddr = (void *)(va + ISP_LUT_MEM_OFS);
		tbl->isp_lsc_tbl_paddr = (void *)(pa + ISP_LENS_MEM_OFS);
		tbl->isp_lsc_tbl_dma_addr = (void *)(dma + ISP_LENS_MEM_OFS);
		tbl->isp_lsc_tbl_vaddr = (void *)(va + ISP_LENS_MEM_OFS);
		...
		tbl->isp_disc_tbl_paddr = (void *)(pa + ISP_DISC_MEM_OFS);
		tbl->isp_disc_tbl_dma_addr = (void *)(dma + ISP_DISC_MEM_OFS);
		tbl->isp_disc_tbl_vaddr = (void *)(va + ISP_DISC_MEM_OFS);
