...
static struct wake_lock aw_pm_wake_lock;
#endif
...
#ifdef CONFIG_HAS_WAKELOCK
	PM_DBG("aw_pm_end wake_lock timeout: 2000 ms\n");
	wake_lock_timeout(&aw_pm_wake_lock, msecs_to_jiffies(2000));
#endif
...
#ifdef CONFIG_HAS_WAKELOCK
	PM_DBG("init wake_lock: aw_pm_end.");
	wake_lock_init(&aw_pm_wake_lock, WAKE_LOCK_SUSPEND, "aw_pm_end");
#endif
