...
static s32 disp_lcd_init(struct disp_lcd* lcd)
{
	...
	if(disp_lcd_is_used(lcd)) {
		/*For A80vr*/
		disp_lcd_power_enable(lcd,2);
		disp_lcd_power_enable(lcd,1);
		disp_lcd_power_enable(lcd,0);
		...
		/*For A80vr*/
		disp_lcd_power_disable(lcd,2);
		mdelay(5);
		disp_lcd_power_disable(lcd,1);
		mdelay(5);
		disp_lcd_power_disable(lcd,0);
	}
