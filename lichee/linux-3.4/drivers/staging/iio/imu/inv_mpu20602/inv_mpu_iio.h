...
#ifdef CONFIG_INV_MPU_IIO_ICM20648
#include "inv_mpu_iio_reg_20648.h"
#endif

#ifdef CONFIG_INV_MPU_IIO_ICM20602
#include "inv_mpu_iio_reg_20602.h"
#endif

#ifdef CONFIG_INV_MPU_IIO_ICM20608D
#include "inv_mpu_iio_reg_20608.h"
#endif

#ifdef CONFIG_INV_MPU_IIO_ICM20690
#include "inv_mpu_iio_reg_20690.h"
#endif
...
struct inv_sensor_accuracy {
	...
	u8 sample_size;
	bool on;
	u16 header; u8 fifo_data_store[HARDWARE_FIFO_SIZE + LEFT_OVER_BYTES];
};
...
int inv_motion_interrupt_control(struct inv_mpu_state *st, u16 motion_event_cntl);
