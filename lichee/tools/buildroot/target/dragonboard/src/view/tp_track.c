...
#if defined (_SUN8IW6P) || (_SUN50IW1P)
...
#if defined (_SUN8IW6P) || (_SUN8IW5P) || (_SUN50IW1P)
...
#endif 
	data_len_tmp = screen_width * screen_height;
	if(data_len_tmp > 1024000)
	{
...
#elif defined _SUN50IW1P
	alloc_data.heap_id_mask = ION_HEAP_SYSTEM_CONTIG_MASK;
#else
