...
{
	printf("[LW101MFN4_MIPI_RGB]LCD_open_flow\n");
...
{
	printf("[LW101MFN4_MIPI_RGB]LCD_close_flow\n");
...
static void LCD_power_on(u32 sel)
{
	printf("[LW101MFN4_MIPI_RGB]LCD_power_on\n");
...
static void LCD_power_off(u32 sel)
{
	printf("[LW101MFN4_MIPI_RGB]LCD_power_off\n");
...
static void LCD_bl_open(u32 sel)
{
	printf("[LW101MFN4_MIPI_RGB]LCD_bl_open\n");
...
static void LCD_bl_close(u32 sel)
{
	printf("[LW101MFN4_MIPI_RGB]LCD_bl_close\n");
...
static void LCD_panel_init(u32 sel)
{
	...
	printf("[LW101MFN4_MIPI_RGB]LCD_panel_init\n");
