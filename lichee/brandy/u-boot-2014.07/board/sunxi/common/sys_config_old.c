...
static int __script_parser_offset(char *script_mod_buf, ulong script_main_key_count, char *main_name)
{
	char   main_bkname[32];
	char   *main_char;
	script_main_key_t  *main_key = NULL;
...
static int __script_parser_fetch_by_offset(char * script_mod_buf, ulong script_main_key_count, int offset, char *sub_name, uint32_t value[])
{
	char   sub_bkname[32];
	char   *sub_char;
	script_main_key_t  *main_key = NULL;
