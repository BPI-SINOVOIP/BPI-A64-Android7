...
#else
       printf("begin to write standard gpt\n");
       if(card_download_standard_gpt(buffer))
       {
           printf("write standard gpt err\n");

           return -1;
       }
       printf("successed to write standard gpt\n");
#endif
	}
...
#else
        printf("sunxi sprite exit fail when downlaod gpt\n");
#endif
		return -1;
	}
