...
int get_mixer(struct mixer_ctls *mixer_ctls)
{
    ...
    /*speaker volume*/
	mixer_ctls->speaker_volume = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_speaker_volume);
    if (!mixer_ctls->speaker_volume) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_speaker_volume);
		goto error_out;
    }

   mixer_ctls->headphone_volume = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_headphone_volume);
    if (!mixer_ctls->headphone_volume) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_headphone_volume);
		goto error_out;
    }

   mixer_ctls->AIF1IN0R_Mux = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_AIF1IN0R_Mux);
    if (!mixer_ctls->AIF1IN0R_Mux) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_AIF1IN0R_Mux);
		goto error_out;
    }

       mixer_ctls->AIF1IN0L_Mux = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_AIF1IN0L_Mux);
    if (!mixer_ctls->AIF1IN0L_Mux) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_AIF1IN0L_Mux);
		goto error_out;
    }

       mixer_ctls->DACR_Mixer_AIF1DA0R_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_DACR_Mixer_AIF1DA0R_Switch);
    if (!mixer_ctls->DACR_Mixer_AIF1DA0R_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_DACR_Mixer_AIF1DA0R_Switch);
		goto error_out;
    }

           mixer_ctls->DACL_Mixer_AIF1DA0L_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_DACL_Mixer_AIF1DA0L_Switch);
    if (!mixer_ctls->DACL_Mixer_AIF1DA0L_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_DACL_Mixer_AIF1DA0L_Switch);
		goto error_out;
    }

           mixer_ctls->Right_Output_Mixer_DACR_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_Right_Output_Mixer_DACR_Switch);
    if (!mixer_ctls->Right_Output_Mixer_DACR_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_Right_Output_Mixer_DACR_Switch);
		goto error_out;
    }

           mixer_ctls->Left_Output_Mixer_DACL_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_Left_Output_Mixer_DACL_Switch);
    if (!mixer_ctls->Left_Output_Mixer_DACL_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_Left_Output_Mixer_DACL_Switch);
		goto error_out;
    }

           mixer_ctls->SPK_L_Mux = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_SPK_L_Mux);
    if (!mixer_ctls->SPK_L_Mux) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_SPK_L_Mux);
		goto error_out;
    }

               mixer_ctls->SPK_R_Mux = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_SPK_R_Mux);
    if (!mixer_ctls->SPK_R_Mux) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_SPK_R_Mux);
		goto error_out;
    }


                   mixer_ctls->External_Speaker_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_External_Speaker_Switch);
    if (!mixer_ctls->External_Speaker_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_External_Speaker_Switch);
		goto error_out;
    }

                       mixer_ctls->Headphone_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_Headphone_Switch);
    if (!mixer_ctls->Headphone_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_Headphone_Switch);
		goto error_out;
    }
    ...
    /*capture*/
                        mixer_ctls->AIF1OUT0L_Mux = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_AIF1OUT0L_Mux);
    if (!mixer_ctls->AIF1OUT0L_Mux) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_AIF1OUT0L_Mux);
		goto error_out;
    }

                            mixer_ctls->AIF1OUT0R_Mux = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_AIF1OUT0R_Mux);
    if (!mixer_ctls->AIF1OUT0R_Mux) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_AIF1OUT0R_Mux);
		goto error_out;
    }

                            mixer_ctls->AIF1_AD0L_Mixer_ADCL_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_AIF1_AD0L_Mixer_ADCL_Switch);
    if (!mixer_ctls->AIF1_AD0L_Mixer_ADCL_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_AIF1_AD0L_Mixer_ADCL_Switch);
		goto error_out;
    }

                            mixer_ctls->AIF1_AD0R_Mixer_ADCR_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_AIF1_AD0R_Mixer_ADCR_Switch);
    if (!mixer_ctls->AIF1_AD0R_Mixer_ADCR_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_AIF1_AD0R_Mixer_ADCR_Switch);
		goto error_out;
    }


                                mixer_ctls->LEFT_ADC_input_Mixer_MIC1_boost_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_LEFT_ADC_input_Mixer_MIC1_boost_Switch);
    if (!mixer_ctls->LEFT_ADC_input_Mixer_MIC1_boost_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_LEFT_ADC_input_Mixer_MIC1_boost_Switch);
		goto error_out;
    }

                                mixer_ctls->RIGHT_ADC_input_Mixer_MIC1_boost_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_RIGHT_ADC_input_Mixer_MIC1_boost_Switch);
    if (!mixer_ctls->RIGHT_ADC_input_Mixer_MIC1_boost_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_RIGHT_ADC_input_Mixer_MIC1_boost_Switch);
		goto error_out;
    }

                                mixer_ctls->RIGHT_ADC_input_Mixer_MIC2_boost_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_RIGHT_ADC_input_Mixer_MIC2_boost_Switch);
    if (!mixer_ctls->RIGHT_ADC_input_Mixer_MIC2_boost_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_RIGHT_ADC_input_Mixer_MIC2_boost_Switch);
		goto error_out;
    }

                                mixer_ctls->LEFT_ADC_input_Mixer_MIC2_boost_Switch = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_LEFT_ADC_input_Mixer_MIC2_boost_Switch);
    if (!mixer_ctls->LEFT_ADC_input_Mixer_MIC2_boost_Switch) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_LEFT_ADC_input_Mixer_MIC2_boost_Switch);
		goto error_out;
    }

                                mixer_ctls->MIC2_SRC = mixer_get_ctl_by_name(mixer,
		    MIXER_AUDIO_MIC2_SRC);
    if (!mixer_ctls->MIC2_SRC) {
	    ALOGE("Unable to find '%s' mixer control", MIXER_AUDIO_MIC2_SRC);
		goto error_out;
    }
