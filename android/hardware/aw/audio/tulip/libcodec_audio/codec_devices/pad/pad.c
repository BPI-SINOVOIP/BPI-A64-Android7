...
static int set_normal_path(struct codec_client *client, int path)
{
   ...
   // mixer_ctl_set_value(client->mixer_ctls->audio_linein_in, 0, 0);  //turn off fm
	...
	if ((headset_on || headphone_on) && speaker_on){
		...
		#if 0
		mixer_ctl_set_value(client->mixer_ctls->External_Speaker_Switch, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->Headphone_Switch, 0, 1);

		mixer_ctl_set_value(client->mixer_ctls->AIF1IN0R_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->AIF1IN0L_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->DACR_Mixer_AIF1DA0R_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->DACL_Mixer_AIF1DA0L_Switch, 0, 1);

		mixer_ctl_set_value(client->mixer_ctls->Right_Output_Mixer_DACR_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->Left_Output_Mixer_DACL_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->SPK_L_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->SPK_R_Mux, 0, 0);
		#endif
		...
		//mixer_ctl_set_value(client->mixer_ctls->SPK_L_Mux, 0, 0);
		//mixer_ctl_set_value(client->mixer_ctls->SPK_R_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->headphone_volume, 0, 50);
		//mixer_ctl_set_value(client->mixer_ctls->SPK_R_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->Headphone_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->External_Speaker_Switch, 0, 0);
		...
		mixer_ctl_set_value(client->mixer_ctls->SPK_L_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->SPK_R_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->speaker_volume, 0, 28);
		//mixer_ctl_set_value(client->mixer_ctls->SPK_R_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->External_Speaker_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->Headphone_Switch, 0, 0);
...
static int set_normal_record(struct codec_client *client, int path)
{
	...
	int headset_on=0;
	 ...
	 if (headset_on) {
		mixer_ctl_set_value(client->mixer_ctls->AIF1OUT0L_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->AIF1OUT0R_Mux, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->AIF1_AD0L_Mixer_ADCL_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->AIF1_AD0R_Mixer_ADCR_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->RIGHT_ADC_input_Mixer_MIC2_boost_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->LEFT_ADC_input_Mixer_MIC2_boost_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->LEFT_ADC_input_Mixer_MIC1_boost_Switch, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->RIGHT_ADC_input_Mixer_MIC1_boost_Switch, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->MIC2_SRC, 0, 0);
		...
		mixer_ctl_set_value(client->mixer_ctls->AIF1_AD0L_Mixer_ADCL_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->AIF1_AD0R_Mixer_ADCR_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->RIGHT_ADC_input_Mixer_MIC2_boost_Switch, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->LEFT_ADC_input_Mixer_MIC2_boost_Switch, 0, 0);
		mixer_ctl_set_value(client->mixer_ctls->LEFT_ADC_input_Mixer_MIC1_boost_Switch, 0, 1);
		mixer_ctl_set_value(client->mixer_ctls->RIGHT_ADC_input_Mixer_MIC1_boost_Switch, 0, 1);
		//mixer_ctl_set_value(client->mixer_ctls->MIC2_SRC, 0, 0);
