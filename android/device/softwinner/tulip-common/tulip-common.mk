...
PRODUCT_COPY_FILES += \
    ...
    device/softwinner/tulip-common/egl/lib/gralloc.sunxi.so:system/lib/hw/gralloc.sun50iw1p1.so \
    device/softwinner/tulip-common/egl/lib/libGLES_mali.so:system/lib/egl/libGLES_mali.so \
    device/softwinner/tulip-common/egl/lib64/gralloc.sunxi.so:system/lib64/hw/gralloc.sun50iw1p1.so \
