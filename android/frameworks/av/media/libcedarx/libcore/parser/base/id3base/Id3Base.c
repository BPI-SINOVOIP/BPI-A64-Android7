...
void Id3BaseGetMetaData(CdxMediaInfoT *mediaInfo, ID3* id3Base)
{
    static const Map CDXMap[] = {
       { ARTIST, kKeyArtist, "TPE1", "TP1" },
       { ALBUM, kKeyAlbum, "TALB", "TAL" },
       { ALBUM_ARTIST, kKeyAlbumArtist, "TPE2", "TP2" },
       { TITLE, kKeyTitle, "TIT2", "TT2" },
       { COMPOSER, kKeyComposer, "TCOM", "TCM" },
       { GENRE, kKeyGenre, "TCON", "TCO" },
       { YEAR, kKeyYear, "TYE", "TYER" },
       { AUTHOR, kKeyAuthor, "TXT", "TEXT" },
       { CDTRACKNUMBER, kKeyCDTrackNumber, "TRK", "TRCK" },
       { DISCNUMBER, kKeyDiscNumber, "TPA", "TPOS" },
       { COMPILATION, kKeyCompilation, "TCP", "TCMP" },
    };
    Iterator* it = NULL;
