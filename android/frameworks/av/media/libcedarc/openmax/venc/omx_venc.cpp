...
#define OMX_SVC_TEST 0
#define OMX_SUPER_FRAME_TEST 0
            ...
            switch (m_sOutPortDefType.format.video.eCompressionFormat)
            {
                case OMX_VIDEO_CodingAVC:
                {
                    if (mIsFromCts == true)
                    {
                        ...
                        nNumberOfProfiles = sizeof(CTSSupportedAVCProfileLevels) /
...
int openVencDriver(omx_venc* pVenc)
{
    ...
    if (pVenc->m_vencCodecType == VENC_CODEC_H264)
    {
        ...
        #if OMX_SUPER_FRAME_TEST
        pVenc->mVideoSuperFrame.bEnable = OMX_TRUE;
        pVenc->mVideoSuperFrame.eSuperFrameMode = OMX_VIDEO_SUPERFRAME_REENCODE;
        pVenc->mVideoSuperFrame.nMaxIFrameBits = 1024*1024/20*3;
        pVenc->mVideoSuperFrame.nMaxPFrameBits = 1024*1024/20*2;
        #endif
        ...
        #if OMX_SVC_TEST
        pVenc->mVideoSVCSkip.bEnable = OMX_TRUE;
        pVenc->mVideoSVCSkip.eSvcLayer = OMX_VIDEO_LAYER_2;
        pVenc->mVideoSVCSkip.uLayerRatio[0] = 66;
        pVenc->mVideoSVCSkip.uLayerRatio[1] = 34;
        pVenc->mVideoSVCSkip.uLayerRatio[2] = 0;
        pVenc->mVideoSVCSkip.uLayerRatio[3] = 0;
        #endif
...
#if 0 // TODO: 1625 should run here.
                pVenc->m_vencColorFormat = VENC_PIXEL_YUV420SP;
#endif
            }
            break;
