...
public class ActivityManager {
    ...
    static public boolean isHighEndGfx() {
        return !(isLowRamDeviceStatic() && (SystemProperties.getBoolean("ro.config.512m", false)))
    ...
    static public boolean supportsMultiWindow() {
        return Resources.getSystem().getBoolean(com.android.internal.R.bool.config_supportsMultiWindow);
    }
