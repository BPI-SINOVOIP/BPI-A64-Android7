...
public class NavigationBarView extends LinearLayout {
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
		...
		//add volume controller down
		mButtonDisatchers.put(R.id.volume_down, new ButtonDispatcher(R.id.volume_down));
		...
		//add volume controller down
		mButtonDisatchers.put(R.id.volume_up, new ButtonDispatcher(R.id.volume_up));
	...
	public ButtonDispatcher getVolumeDownButton() {
		return mButtonDisatchers.get(R.id.volume_down);
	}

	public ButtonDispatcher getVolumeUpButton() {
		return mButtonDisatchers.get(R.id.volume_up);
	}
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
		...
		getVolumeDownButton().setVisibility(View.VISIBLE);
        getBackButton().setVisibility(disableBack      ? View.INVISIBLE : View.VISIBLE);
        getHomeButton().setVisibility(disableHome      ? View.INVISIBLE : View.VISIBLE);
        getRecentsButton().setVisibility(disableRecent ? View.INVISIBLE : View.VISIBLE);
		getVolumeUpButton().setVisibility(View.VISIBLE);
    }
