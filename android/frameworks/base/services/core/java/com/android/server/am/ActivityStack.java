...
final class ActivityStack {
	...
	if(r.realActivity.getClassName().equals("com.android.settings.FallbackHome")||r.realActivity.getClassName().equals("com.google.android.setupwizard.SetupWizardActivity")||r.realActivity.getClassName().equals("com.google.android.setupwizard.network.NetworkActivity")){
	        ConnectivityService connectService =(ConnectivityService) IConnectivityManager.Stub.asInterface(ServiceManager.getService("connectivity"));
		if(connectService!=null){		      
		      connectService.isSupport=false;
		}
	}
	
	if(r.realActivity.getClassName().equals("com.google.android.setupwizard.user.SuggestedActionsActivity")||r.realActivity.getClassName().equals("com.google.android.setupwizard.user.DeviceOwnerWarningActivity")){	 
	        ConnectivityService connectService =(ConnectivityService) IConnectivityManager.Stub.asInterface(ServiceManager.getService("connectivity"));
		if(connectService!=null){
		     connectService.isSupport=true;			
		}
	}
