...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    boolean mShowNavigationBarAtBottom = false;
	...
	//bpi, how navigationbar at bottom for lcd7(800x480)
	mShowNavigationBarAtBottom = res.getBoolean(com.android.internal.R.bool.config_showNavigationBarAtBottom);
	if (mShowNavigationBarAtBottom) {
