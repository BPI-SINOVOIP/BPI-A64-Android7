...
public abstract class InstrumentedFragment extends PreferenceFragment {
    ...
    public static final int REBOOT_RECOVERY = UNDECLARED + 2;
    public static final int REBOOT_RECOVERY_CONFIRM = UNDECLARED + 3;
	public static final int BACKGROUND_CLEANUP = UNDECLARED + 4;
