...
public class ConfigureWifiSettings extends SettingsPreferenceFragment
    ...
    private void initPreferences() {
		...
		SwitchPreference captivePortalDetection =
                (SwitchPreference) findPreference(KEY_CAPTIVE_PORTAL_DETECTION);
        captivePortalDetection.setChecked(Settings.Global.getInt(getContentResolver(),
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        } else if (KEY_CAPTIVE_PORTAL_DETECTION.equals(key)){
            Settings.Global.putInt(getContentResolver(),
