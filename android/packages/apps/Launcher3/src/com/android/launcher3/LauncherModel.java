...
public class LauncherModel extends BroadcastReceiver
    ...
    public void onPackageAdded(String packageName, UserHandleCompat user) {
        ...
        for(int in = 0 ;in < LauncherAppState.getInstance().favorites.size(); in++) {
            if(LauncherAppState.getInstance().favorites.get(in).getPackageName().equals(packageName)) {
                try {
                    ...
                    final ComponentName cn = new ComponentName(f.getPackageName(), f.getClassName());
                    ...
                    addItemToDatabase(context, info, f.getContainer(), info.screenId, info.cellX, info.cellY);
                            ...
                            case LauncherSettings.Favorites.ITEM_TYPE_DEEP_SHORTCUT:
                                ...
                                if (info != null) {
                                    ...
                                    case LauncherSettings.Favorites.CONTAINER_HOTSEAT:
                                        ...
                                        for(int in = 0 ;in < LauncherAppState.getInstance().favorites.size(); in++) {
                                            if(LauncherAppState.getInstance().favorites.get(in).getPackageName().equals(info.intent.getComponent().getPackageName())) {
                                                LauncherAppState.getInstance().favorites.remove(in);
                                                break;
                                            }
                                        }
